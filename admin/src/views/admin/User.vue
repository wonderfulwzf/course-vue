    ...
    export default {
        ...
        methods: {
            ...
            list(page) {
                ...
                _this.$ajax
                    .post(
                        process.env.VUE_APP_SERVER+"/business/admin/user/list",
                        //传参对象
                        {
            ...
            save() {
                ...
                _this.$ajax
                    .post(
                        process.env.VUE_APP_SERVER+"/business/admin/user/save",
                        //传参对象
                        _this.user
                    )
                    .then(
            ...
            update() {
                ...
                _this.$ajax
                    .post(
                        process.env.VUE_APP_SERVER+"/business/admin/user/update",
                        //传参对象
                        _this.user
                    )
                    .then(
            ...
            del(id) {
                ...
                Confirm.show("删除后将不可恢复！", function() {
                    //确认删除
                    _this.$ajax
                        .delete(process.env.VUE_APP_SERVER+"/business/admin/user/delete/" + id)
                        .then(
                            //响应结果
                            (response) => {
